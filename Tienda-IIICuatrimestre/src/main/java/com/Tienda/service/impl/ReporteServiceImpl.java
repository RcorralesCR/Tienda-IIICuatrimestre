...
public class ReporteServiceImpl implements ReporteService{
    ...
    public ResponseEntity<Resource> generarReporte(String reporte, Map<String, Object> parametros, String tipo) throws IOException {
        ...
        try{
            //Se define el tipo de salida de reporte
            ...
            //En salida quedará el reporte ya creado
            ...
            reportePath + File.pathSeparator + reporte + ".jasper");
            
            //Un objeto para leer efectivamente el reorte
            
            InputStream elReporte = fuente.getInputStream();
            
            //Se crea el reporte
            
            var reporteJasper = JasperFillManager.fillReport(elReporte, parametros, 
